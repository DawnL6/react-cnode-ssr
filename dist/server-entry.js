...
var AppState = (_class = function () {
  function AppState() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { count: 0, name: 'liqz' },
        count = _ref.count,
        name = _ref.name;
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(AppState, 'AppState', 'F:/study/react-cnode-ssr/client/store/app-state.js');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(_default, 'default', 'F:/study/react-cnode-ssr/client/server-entry.js');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(APP, 'APP', 'F:/study/react-cnode-ssr/client/views/App.jsx');
}();
...
var _default = function _default() {
  return [_react2.default.createElement(_reactRouterDom.Route, { path: '/', render: function render() {
    ...
    }, exact: true, key: 'first' }), _react2.default.createElement(_reactRouterDom.Route, { path: '/list', component: _index2.default, exact: true, key: 'list' }), _react2.default.createElement(_reactRouterDom.Route, { path: '/detail', component: _index4.default, key: 'detail' }), _react2.default.createElement(_reactRouterDom.Route, { path: '/test', component: _apiTest2.default, key: 'testApi' })];
};
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(_default, 'default', 'F:/study/react-cnode-ssr/client/config/router.jsx');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(TopicList, 'TopicList', 'F:/study/react-cnode-ssr/client/views/topic-list/index.jsx');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(TopicDetail, 'TopicDetail', 'F:/study/react-cnode-ssr/client/views/topic-detail/index.jsx');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(TestApi, 'TestApi', 'F:/study/react-cnode-ssr/client/views/test/api-test.jsx');
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(AppState, 'AppState', 'F:/study/react-cnode-ssr/client/store/store.js');

  __REACT_HOT_LOADER__.register(createStoreMap, 'createStoreMap', 'F:/study/react-cnode-ssr/client/store/store.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'F:/study/react-cnode-ssr/client/store/store.js');
}();
